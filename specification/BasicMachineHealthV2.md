...
| `"Tire"`               | should    | Array&lt;[TireStatus](#tire-status-object)&gt; | -    | A list of tire information       | 
| `"Additional"`         | may       | Array&lt;[SensorReading](#sensor-reading-object)&gt;      | -    | Additional sensor measurements |
